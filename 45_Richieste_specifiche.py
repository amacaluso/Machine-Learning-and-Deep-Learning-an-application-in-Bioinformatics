...
# test_type_ct = tipo[ tipo != training_type_ct ]
...
for t in tipo:
    ...
    #    y = target_variables[0]
        print( y , "\n\n")
        train_data = dataset[ dataset['Cancer Type'] == training_type_ct]
...
writer = pd.ExcelWriter('results/train_blood/test_set_diviso_per_ct/Regressione_lineare_blood.xlsx')
...
writer = pd.ExcelWriter('results/train_blood/test_set_diviso_per_ct/SVM_blood.xlsx')
...
writer = pd.ExcelWriter('results/train_blood/test_set_diviso_per_ct/dicMLP_blood.xlsx')
